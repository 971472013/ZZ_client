            ...
            <div class="panel panel-info">
                <div class="panel-heading"></a></li>
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="/Order_cancel">已撤销的订单
                ...
                <div class="panel-body">
                    <table id="t" class="table">
                        ...
                        <tr v-for="i in data">
                            ...
                            <td width="100px">{{i.cancel_time}}</td>
                            <td width="100px">{{i.r_m}}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    ,cancel_time:"<%=list.get(i).getCancel_time()%>",r_m:"<%=list.get(i).getTotal()*0.8%>"};
    <%}%>
    new Vue({
        el:"#t",
        data:data,
